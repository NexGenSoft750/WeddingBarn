            ...
            <div class="ss-s ss-bg">
                ...
                <div class="sc" style="width:1200px">
                    ...
                    <div data-sid="review-header_4" class="sie-review-header_4 se">
                        <h3 class="se-t sie-review-header_4-text st-m-subheading st-d-subheading se-rc">Venue grand
                            opening in March 2025! We welcome your reviews!</h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="ss-s ss-bg">
                <div class="sc" style="width:1200px">
                    ...
                    <div data-sid="more-reviews_1" class="sie-more-reviews_1 se">
                        <p class="se-t sie-more-reviews_1-text st-m-paragraph st-d-paragraph se-rc">Welcome to Acre
                            31! We are thrilled to announce that our beautiful barn venue, set on 31 acres of
                            picturesque property, will be opening its doors in March 2025. While we don’t have
                            reviews to share just yet, we are eagerly anticipating the wonderful experiences and
                            memories that our couples will create here.
                            <br><br>As we prepare for our grand opening, we invite you to check back often as we
                            look forward to filling this page with
                            heartfelt reviews from our couples and their families. Your feedback will help us
                            continue to create unforgettable experiences and ensure that every wedding at Acre 31 is
                            nothing short of magical.<br><br>Thank you for considering Acre 31 for your wedding
                            celebration. We can’t wait to welcome you and be a part of your journey! Stay tuned for
                            updates and reviews as we embark on this exciting adventure together.

                        </p>
                    </div>
                    <div data-sid="more-reviews_2" class="sie-more-reviews_2 se">
                        <h2 class="se-t sie-more-reviews_2-text st-m-heading st-d-heading se-rc">Kind Words About Acre
                            31<br>Coming Soon....</h2>
                    </div>
