...
<head>
    ...
    <style id="si-page-css">
        ...
        .m .sib-review-header .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .d .sib-review-header .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .d .sie-review-header_0 {
            left: 323px;
            top: 152px;
            width: 555px;
            height: 253px;
        ...
        .d .sie-review-header_0 .se-simple:hover {}

        .m .sie-review-header_0 .se-simple:hover {}

        .d .sie-review-header_0 .se-simple {
            background-color: rgba(255, 255, 255, 1);
        }

        .m .sie-review-header_0 .se-simple {
            background-color: rgba(255, 255, 255, 1);
        }

        .d .sie-review-header_1 {
            left: 363px;
            top: 328px;
            width: 475px;
            height: 29px;
        ...
        .m .sie-review-header_1-text {
            line-height: 1.6;
        }

        .d .sie-review-header_2 {
            left: 322px;
            top: 152px;
            width: 556px;
            height: 6px;
        ...
        .d .sie-review-header_2 .se-simple:hover {}

        .m .sie-review-header_2 .se-simple:hover {}

        .d .sie-review-header_2 .se-simple {
            background-color: rgba(56, 79, 114, 1);
        }

        .m .sie-review-header_2 .se-simple {
            background-color: rgba(56, 79, 114, 1);
        }

        .d .sie-review-header_3 {
            left: 547px;
            top: 262px;
            width: 106px;
            height: 32px;
        ...
        .m .sib-more-reviews .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .d .sib-more-reviews .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .d .sie-more-reviews_0 {
            left: 483px;
            top: 39px;
            width: 234px;
            height: 10px;
        ...
        .d .sie-more-reviews_0-text {
            color: rgba(4, 4, 4, 1);
            letter-spacing: 0.3em;
            font-size: 9px;
        }

        .m .sie-more-reviews_0-text {
            letter-spacing: 0.3em;
            font-size: 10px;
        }

        .d .sie-more-reviews_1 {
            left: 133px;
            top: 135px;
            width: 938px;
            height: 2314px;
        ...
        .m .sie-more-reviews_1-text {
            color: rgba(4, 4, 4, 1);
            text-align: center;
        }

        .d .sie-more-reviews_2 {
            left: 292px;
            top: 68px;
            width: 616px;
            height: 35px;
        ...
        .d .sie-more-reviews_2-text {
            color: rgba(56, 79, 114, 1);
            text-transform: capitalize;
        }

        .m .sie-more-reviews_2-text {
            color: rgba(56, 79, 114, 1);
        }
