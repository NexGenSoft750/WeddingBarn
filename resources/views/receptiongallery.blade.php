...
<head>
    ...
    <style id="si-page-css">
        ...
        .m .sib-receptions-gallery {
            height: 700px;
        }

        .d .sib-receptions-gallery {
            height: 878px;
        }

        .m .sib-receptions-gallery .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .d .sib-receptions-gallery .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .m .sib-receptions-gallery.sb-nm-dH .sc {
            height: 700px;
        }

        .d .sib-receptions-gallery.sb-nd-dH .sc {
            height: 878px;
        }

        .m .sib-receptions-gallery .sis-receptions-gallery_select-gallery {
            background-color: rgba(0, 0, 0, 0);
        }

        .d .sib-receptions-gallery .sis-receptions-gallery_select-gallery {
            background-color: rgba(0, 0, 0, 0);
        }

        .d .sie-receptions-gallery_select-gallery_0 {
            left: 426px;
            top: 41px;
            width: 348px;
            height: 39px;
        ...
        .m .sie-receptions-gallery_select-gallery_0 {
            left: 26.5px;
            top: 56px;
            width: 267px;
            height: 41px;
        ...
        .d .sie-receptions-gallery_select-gallery_0-text {
            color: rgba(56, 79, 114, 1);
            text-transform: lowercase;
            line-height: 1.2;
            letter-spacing: 0.1em;
        ...
        .m .sie-receptions-gallery_select-gallery_0-text {
            color: rgba(56, 79, 114, 1);
            text-transform: lowercase;
            line-height: 1;
            letter-spacing: 0.1em;
        ...
        .d .sie-receptions-gallery_select-gallery_1 {
            left: 483px;
            top: 32px;
            width: 234px;
            height: 18px;
        ...
        .m .sie-receptions-gallery_select-gallery_1 {
            left: 30.5px;
            top: 38.5px;
            width: 259px;
            height: 16px;
        ...
        .d .sie-receptions-gallery_select-gallery_1-text {
            color: rgba(4, 4, 4, 1);
            text-transform: uppercase;
            letter-spacing: 0.3em;
            font-size: 9px;
        ...
        .m .sie-receptions-gallery_select-gallery_1-text {
            color: rgba(78, 78, 78, 1);
            text-transform: uppercase;
            letter-spacing: 0.3em;
            font-size: 9px;
        ...
        .d .sie-receptions-gallery_select-gallery_2 {
            left: 145px;
            top: 95px;
            width: 910px;
            height: 3844px;
        ...
        .m .sie-receptions-gallery_select-gallery_2 {
            left: 15px;
            top: 138px;
            width: 291px;
            height: 2754px;
        ...
        .d .sig-receptions-gallery_select-gallery_2 {
            width: 100%;
            padding: 2px;
            position: relative;
        ...
        .d .sig-receptions-gallery_select-gallery_2 .stg-grid-sizer {
            width: 33.333%;
        }

        .d .sig-receptions-gallery_select-gallery_2 .stg-grid-item {
            width: 33.333%;
            padding: 2px;
        }

        .d .sig-receptions-gallery_select-gallery_2 .stg-grid-img {
            border-width: 0px;
            border-color: rgba(139, 139, 139, 1);
            border-style: solid;
        }

        .d .sig-receptions-gallery_select-gallery_2-stg-slider.stg-slider {
            background-color: rgba(0, 0, 0, 1);
        }

        .d .sig-receptions-gallery_select-gallery_2-stg-slider .stg-slider-controls {
            color: #FFFFFF;
        }

        .d .sig-receptions-gallery_select-gallery_2-stg-slider .stg-slider-controls svg path {
            fill: #FFFFFF;
        }

        .m .sig-receptions-gallery_select-gallery_2 {
            width: 100%;
            padding: 1px;
            position: relative;
            box-sizing: border-box;
        ...
        .m .sig-receptions-gallery_select-gallery_2 .stg-grid-sizer {
            width: 50.000%;
        }

        .m .sig-receptions-gallery_select-gallery_2 .stg-grid-item {
            width: 50.000%;
            padding: 1px;
        }

        .m .sig-receptions-gallery_select-gallery_2 .stg-grid-img {}

        .m .sig-receptions-gallery_select-gallery_2-stg-slider.stg-slider {
            background-color: rgba(0, 0, 0, 1);
        }

        .m .sig-receptions-gallery_select-gallery_2-stg-slider .stg-slider-controls {
            color: #FFFFFF;
        }

        .m .sig-receptions-gallery_select-gallery_2-stg-slider .stg-slider-controls svg path {
            fill: #FFFFFF;
        }
