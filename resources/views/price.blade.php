...
<head>
    ...
    <style id="si-page-css">
       ...
       /* General Styles for Image Containers */
...
<body>
            ...
            <div class="ss-s ss-bg">
                <div class="sc" style="width:1200px">
                    ...
                    <div data-sid="pricing-intro_2" class="sie-pricing-intro_2 se">
                        <h1 class="se-t sie-pricing-intro_2-text st-m-subheading st-d-subheading se-rc">2025 SINGLE DAY PACKAGES PRICING GUIDE
                            <br><br><a
        ...
        <div id="cta-pricing" data-bid="cta-pricing" class="sb sib-cta-pricing">
            ...
            <div class="ss-s ss-bg">
                <div class="sc" style="width:1200px">
                    ...
                    <div data-sid="pricing-intro_2" class="sie-pricing-intro_2 se">
                        <h1 class="se-t sie-pricing-intro_2-text st-m-subheading st-d-subheading se-rc">2025 MULTI-DAY PACKAGES PRICING GUIDE
                            <br><br><a
                                href="https://www.canva.com/design/DAGayHWrj44/xv8XT4ZFMxyJ8uR6dglfqA/view?utm_content=DAGayHWrj44&amp;utm_campaign=designshare&amp;utm_medium=link2&amp;utm_source=uniquelinks&amp;utlId=h2248b5d159"
                                target="_blank">available 2025 dates&nbsp;</a><br></h1>
                    </div>
         ...
         <div id="pricing-multi-day" data-bid="pricing-multi-day" class="sb sib-pricing-multi-day">
            <div class="ss-s ss-bg">
                ...
                <div class="sc" style="width:1200px">
                    ...
                    <div data-sid="pricing_3" class="sie-pricing_3 se">
                        <h2 class="se-t sie-pricing_3-text st-m-heading st-d-subheading se-rc">Fri&Sat<br></h2>
                    </div>
                    <div data-sid="pricing_4" class="sie-pricing_4 se">
                    ...
                    <div data-sid="pricing_7" class="sie-pricing_7 se">
                        <h2 class="se-t sie-pricing_7-text st-m-heading st-d-subheading se-rc">Sat&Sun</h2>
                    </div>
                    <div data-sid="pricing_8" class="sie-pricing_8 se">
                        <h2 class="se-t sie-pricing_8-text st-m-heading st-d-subheading se-rc">Fri-sat-sun</h2>
                    </div>
                    <div data-sid="pricing_9" class="sie-pricing_9 se">
                        <h2 class="se-t sie-pricing_9-text st-m-heading st-d-subheading se-rc">Multi-Day non-peak SEASON<br>JAN
                            FEB JUL AUG<br></h2>
                    </div>
                    <div data-sid="pricing_10" class="sie-pricing_10 se">
                        <h2 class="se-t sie-pricing_10-text st-m-heading st-d-subheading se-rc">Sat&Sun<br></h2>
                    </div>
                    <div data-sid="pricing_11" class="sie-pricing_11 se">
                        <h2 class="se-t sie-pricing_11-text st-m-heading st-d-heading se-rc">${{ $prices->multi_day_friday_saturday_peak }}</h2>
                    </div>
                    <div data-sid="pricing_12" class="sie-pricing_12 se">
                        <h2 class="se-t sie-pricing_12-text st-m-heading st-d-heading se-rc">${{ $prices->full_weekend_only }}</h2>
                    </div>
                    <div data-sid="pricing_13" class="sie-pricing_13 se">
                        <h2 class="se-t sie-pricing_13-text st-m-heading st-d-heading se-rc">${{ $prices->multi_day_saturday_sunday_peak }}</h2>
                    </div>
                    <div data-sid="pricing_14" class="sie-pricing_14 se">
                        <h2 class="se-t sie-pricing_14-text st-m-heading st-d-heading se-rc">${{ $prices->full_weekend_peak }}</h2>
                    </div>
                    <div data-sid="pricing_15" class="sie-pricing_15 se">
                        <h2 class="se-t sie-pricing_15-text st-m-heading st-d-heading se-rc">${{ $prices->multi_day_saturday_sunday_non_peak }}</h2>
                    </div>
                    <div data-sid="pricing_16" class="sie-pricing_16 se">
                        <h3 class="se-t sie-pricing_16-text st-m-heading st-d-subheading se-rc">${{ $prices->full_weekend_non_peak }}</h3>
                    </div>
                    <div data-sid="pricing_17" class="sie-pricing_17 se">
                        <h3 class="se-t sie-pricing_17-text st-m-heading st-d-subheading se-rc">${{ $prices->multi_day_friday_saturday_non_peak }}</h3>
                    </div>
                    <div data-sid="pricing_18" class="sie-pricing_18 se">
                        <h3 class="se-t sie-pricing_18-text st-m-subheading st-d-subheading se-rc">Multi-Day peak
                            season<br>March-Jun | Sept-Dec<br></h3>
                    </div>
    ...
    <div class="ss-s ss-bg">
            ...
            <div data-sid="in-house-upgrades_0" class="sie-in-house-upgrades_0 se">
                <h3 class="se-t sie-in-house-upgrades_0-text st-m-subheading st-d-subheading se-rc">Explore our</h3>
            </div>
            <div data-sid="in-house-upgrades_1" class="sie-in-house-upgrades_1 se">
                <h2 class="se-t sie-in-house-upgrades_1-text st-m-heading st-d-heading se-rc">A La Carte Extras</h2>
            </div>

            <!-- Image container with custom CSS Grid -->
          <div class="image-grid">
    @foreach ($priceimages as $image)
        <div class="image-container">
            <img
                src="{{ Storage::url($image->image_path) }}"
                class="img-fluid"
                alt="{{ $image->alt_text ?? 'Photo' }}"
                title="{{ $image->title ?? 'No Title' }}" />
            <p class="image-text mt-2">
    ...
    @endforeach
            ...
            <!-- Image Section with Noscript Fallback -->
