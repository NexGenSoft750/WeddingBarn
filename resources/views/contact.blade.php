                ...
                <div class="sc"><a href="javascript:void(0)" target="_self"
                    ...
                    <div data-sid="contact-form-zapier_view-1_32" class="sie-contact-form-zapier_view-1_32 se">
                        <p class="se-t sie-contact-form-zapier_view-1_32-text st-m-paragraph st-d-paragraph se-rc">
                            <b><i>Our office is closed on Mondays.</i></b><br>
                        </p>
                    </div><a href="{{ route('book') }}" target="_self" class="sie-contact-form-zapier_view-1_34 se"
                        data-sid="contact-form-zapier_view-1_34">
                        <div class="se-simple"></div>
                    </a><a href="{{ route('book') }}" target="_self" class="sie-contact-form-zapier_view-1_35 se"
                        data-sid="contact-form-zapier_view-1_35">
                    ...
                    </a><a href="{{ route('price') }}" target="_self" class="sie-contact-form-zapier_view-1_36 se"
                        data-sid="contact-form-zapier_view-1_36">
                        <div class="se-simple"></div>
                    </a><a href="{{ route('price') }}" target="_self" class="sie-contact-form-zapier_view-1_37 se"
