 <div id="announcement-header" data-bid="announcement-header" class="sb sib-announcement-header">
     <div class="ss-s ss-bg">
         <div class="sc" style="width:1200px"><a href="https://forms.gle/VXMdyEYTWB2YAF3w5" target="_self"
             ...
             </a><a href="https://forms.gle/VXMdyEYTWB2YAF3w5" target="_blank" class="sie-announcement-header_2 se"
                 data-sid="announcement-header_2">
 ...
 <div id="drop-navigation" data-bid="drop-navigation" class="sb sib-drop-navigation sb-lm sb-ld">
     ...
     <div id="drop-navigation_view-1" class="ss sis-drop-navigation_view-1 sactive">
         <div class="sc"><a href="contact-book-your-tour.html" target="_self"
             ...
             </a><a href="#/" target="_self" class="sie-drop-navigation_view-1_5 se se-pc"
                 data-sid="drop-navigation_view-1_5">
                 <div style="width:100%;height:100%" data-img="drop-navigation_view-1_5" class="se-img se-gr slzy">
                 </div><noscript><img
                         src="../static.showit.co/400/KemWYaQ8SuytUbAoKiyJJA/105740/kendall-point-square-logo-no-tag-white.png"
                         class="se-img" alt="" title="Kendall-Point-Square-Logo-No-Tag-White" /></noscript>
             </a><a href="{{ route('book') }}" target="_self" class="sie-drop-navigation_view-1_6 se"
     ...
     <div id="drop-navigation_view-1-1" class="ss sis-drop-navigation_view-1-1">
         <div class="sc"><a href="contact-book-your-tour.html" target="_self"
                 ...
                 <div class="se-simple"></div>
             </a><a href="{{ route('amenities') }}" target="_self" class="sie-drop-navigation_view-1-1_1 se"
             ...
             </a><a href="#/" target="_self" class="sie-drop-navigation_view-1-1_5 se se-pc"
                 data-sid="drop-navigation_view-1-1_5">
                 <div style="width:100%;height:100%" data-img="drop-navigation_view-1-1_5" class="se-img se-gr slzy">
                 </div><noscript><img
                         src="../static.showit.co/400/KemWYaQ8SuytUbAoKiyJJA/105740/kendall-point-square-logo-no-tag-white.png"
                         class="se-img" alt="" title="Kendall-Point-Square-Logo-No-Tag-White" /></noscript>
             </a><a href="{{ route('book') }}" target="_self" class="sie-drop-navigation_view-1-1_6 se"
             ...
             <div data-sid="drop-navigation_view-1-1_7" class="sie-drop-navigation_view-1-1_7 se">
                 <div class="se-simple"></div>
             </div><a href="{{ route('amenities') }}" target="_self" class="sie-drop-navigation_view-1-1_8 se"
 ...
 <div id="mobile-nav" data-bid="mobile-nav" class="sb sib-mobile-nav sb-lm">
     <div class="ss-s ss-bg">
         <div class="sc" style="width:1200px">
             ...
             </a><a href="https://www.instagram.com/kendallpointvenue/" target="_self" class="sie-mobile-nav_3 se"
                 data-sid="mobile-nav_3">
                 <div class="se-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                         <path
             ...
             </a><a href="https://www.facebook.com/kendallpointvenue" target="_blank" class="sie-mobile-nav_4 se"
                 data-sid="mobile-nav_4">
                 <div class="se-icon"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                         <path
             ...
             <a href="{{ route('microwedding') }}" target="_self" class="sie-mobiles-nav_13 se"
                 data-sid="mobile-nav_13">
                 <p class="se-t sie-mobile-nav_13-text st-m-paragraph st-d-paragraph">Micro<br></p>
             </a>
         </div>
     </div>
 </div>
 ...
 <div id="navigation" data-bid="navigation" class="sb sib-navigation sb-lm sb-ps">
     <div class="ss-s ss-bg">
         <div class="sc" style="width:1200px">
             ...
             <a href="{{ route('contact') }}" target="_self" class="sie-navigation_2 se" data-sid="navigation_2">
     ...
     <div id="navigation_view-1" class="ss sis-navigation_view-1 sactive">
         <div class="sc"><a href="contact-book-your-tour.html" target="_self" class="sie-navigation_view-1_0 se"
                 data-sid="navigation_view-1_0">
                 <div class="se-simple"></div>
     ...
     <div id="navigation_view-1-1" class="ss sis-navigation_view-1-1">
         <div class="sc"><a href="contact-book-your-tour.html" target="_self"
                 ...
                 <div style="width:100%;height:100%" data-img="navigation_view-1-1_2" class="se-img se-gr slzy">
                 </div><noscript><img
     ...
     <div id="navigation_view-2" class="ss sis-navigation_view-2">
         <div class="sc"><a href="{{ route('about') }}" target="_self"
                 class="sie-navigation_view-2_0 se se-stl" data-sid="navigation_view-2_0" data-scrollto="#navigation"
                 data-state="navigation|0|0|0">
             ...
             <div data-sid="navigation_view-2_1" class="sie-navigation_view-2_1 se">
                 ...
                 <p class="se-t sie-navigation_view-2_2-text st-m-paragraph st-d-paragraph">San Antonio Wedding
                     Venue</p>
             </a><a href="{{ route('about') }}" target="_self" class="sie-navigation_view-2_3 se"
