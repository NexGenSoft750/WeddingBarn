...
<head>
    ...
    <style id="si-page-css">
        ...
        .m .sib-ceremonies-gallery {
            height: 1001px;
        }

        .d .sib-ceremonies-gallery {
            height: 1302px;
        }

        .m .sib-ceremonies-gallery .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .d .sib-ceremonies-gallery .ss-bg {
            background-color: rgba(255, 255, 255, 1);
        }

        .m .sib-ceremonies-gallery.sb-nm-dH .sc {
            height: 1001px;
        }

        .d .sib-ceremonies-gallery.sb-nd-dH .sc {
            height: 1302px;
        }

        .m .sib-ceremonies-gallery .sis-ceremonies-gallery_select-gallery {
            background-color: rgba(0, 0, 0, 0);
        }

        .d .sib-ceremonies-gallery .sis-ceremonies-gallery_select-gallery {
            background-color: rgba(0, 0, 0, 0);
        }

        .d .sie-ceremonies-gallery_select-gallery_0 {
            left: 442px;
            top: 43px;
            width: 316px;
            height: 35px;
        ...
        .m .sie-ceremonies-gallery_select-gallery_0 {
            left: 26.5px;
            top: 56px;
            width: 267px;
            height: 41px;
        ...
        .d .sie-ceremonies-gallery_select-gallery_0-text {
            color: rgba(56, 79, 114, 1);
            text-transform: lowercase;
            line-height: 1.2;
            letter-spacing: 0.1em;
        ...
        .m .sie-ceremonies-gallery_select-gallery_0-text {
            color: rgba(56, 79, 114, 1);
            text-transform: lowercase;
            line-height: 1;
            letter-spacing: 0.1em;
        ...
        .d .sie-ceremonies-gallery_select-gallery_1 {
            left: 483px;
            top: 32px;
            width: 234px;
            height: 18px;
        ...
        .m .sie-ceremonies-gallery_select-gallery_1 {
            left: 30.5px;
            top: 38.5px;
            width: 259px;
            height: 16px;
        ...
        .d .sie-ceremonies-gallery_select-gallery_1-text {
            color: rgba(4, 4, 4, 1);
            text-transform: uppercase;
            letter-spacing: 0.3em;
            font-size: 9px;
        ...
        .m .sie-ceremonies-gallery_select-gallery_1-text {
            color: rgba(78, 78, 78, 1);
            text-transform: uppercase;
            letter-spacing: 0.3em;
            font-size: 9px;
        ...
        .d .sie-ceremonies-gallery_select-gallery_2 {
            left: 145px;
            top: 95px;
            width: 910px;
            height: 1100px;
        ...
        .m .sie-ceremonies-gallery_select-gallery_2 {
            left: 13px;
            top: 140px;
            width: 291px;
            height: 820px;
        ...
        .d .sig-ceremonies-gallery_select-gallery_2 {
            width: 100%;
            padding: 2px;
            position: relative;
        ...
        .d .sig-ceremonies-gallery_select-gallery_2 .stg-grid-sizer {
            width: 33.333%;
        }

        .d .sig-ceremonies-gallery_select-gallery_2 .stg-grid-item {
            width: 33.333%;
            padding: 2px;
        }

        .d .sig-ceremonies-gallery_select-gallery_2 .stg-grid-img {
            border-width: 0px;
            border-color: rgba(139, 139, 139, 1);
            border-style: solid;
        }

        .d .sig-ceremonies-gallery_select-gallery_2-stg-slider.stg-slider {
            background-color: rgba(0, 0, 0, 1);
        }

        .d .sig-ceremonies-gallery_select-gallery_2-stg-slider .stg-slider-controls {
            color: #FFFFFF;
        }

        .d .sig-ceremonies-gallery_select-gallery_2-stg-slider .stg-slider-controls svg path {
            fill: #FFFFFF;
        }

        .m .sig-ceremonies-gallery_select-gallery_2 {
            width: 100%;
            padding: 1px;
            position: relative;
            box-sizing: border-box;
        ...
        .m .sig-ceremonies-gallery_select-gallery_2 .stg-grid-sizer {
            width: 50.000%;
        }

        .m .sig-ceremonies-gallery_select-gallery_2 .stg-grid-item {
            width: 50.000%;
            padding: 1px;
        }

        .m .sig-ceremonies-gallery_select-gallery_2 .stg-grid-img {}

        .m .sig-ceremonies-gallery_select-gallery_2-stg-slider.stg-slider {
            background-color: rgba(0, 0, 0, 1);
        }

        .m .sig-ceremonies-gallery_select-gallery_2-stg-slider .stg-slider-controls {
            color: #FFFFFF;
        }

        .m .sig-ceremonies-gallery_select-gallery_2-stg-slider .stg-slider-controls svg path {
            fill: #FFFFFF;
        }
